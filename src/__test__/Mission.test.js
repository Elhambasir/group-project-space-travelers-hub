...
describe('render rockets', () => {
  ...
  test('The reservation state of the Falcon 1 should be true', () => {
    ...
    expect(missions.missions[0].reserved).toBe(false);
  });

  test('The reservation state of the Falcon 9 should be False', () => {

    store.dispatch(joinMission('F3364BF'))

    expect(missions.missions[2].reserved).toBe(true);
  });
  test('The reservation state of the Starship should be False', () => {
    store.dispatch(joinMission('CE91D46'))

    expect(missions.missions[7].reserved).toBe(true);
  });
});